...
<h1>Avaliador de conhecimento bruto</h1>
	...
	<div class="panel-body">
		...
		<h3 id="categoria">
			<?php
				...
				echo  ($search['categoria']);
			?>
		</h3>
		<br>
			
		<input type="text" class="form-control" readonly id="ingles" name="ingles" value="<?php echo  ($search['palavra']);?>">
		&nbsp&nbsp&nbsp
		
		<select id="traducao" class="form-control" name="traducao" onChange="Send(this.value,'<?php echo  ($search['palavra']);?>')">
			<option value="">Resposta:</option>
			<?php
			while($trad = mysqli_fetch_array($phrasal1))
			{
				if( ($trad['traducao']) ==  ($search['traducao']))
				{
					$valor_verdadeiro =  ($trad['traducao']);
				}
			}
		  ...
		  <?php $i++;
				...
				$i++;	?>
			<option value="<?php echo  ($trad1['traducao']) ?>"><?php echo  ($trad1['traducao'])?></option>
		<?php	}?>
	...
	<div class="panel-body">
		...
		<h3 id="categoria">
			<?php
				...
				echo  ($search1['categoria']);
			?>
		</h3>
		<br>
			
		<input type="text" class="form-control" readonly id="ingles" value="<?php echo  ($search1['palavra']);?>">
		&nbsp&nbsp&nbsp
		
		<select id="traducao" class="form-control" name="traducao" onChange="Send(this.value,'<?php echo  ($search1['palavra']);?>')">
			<option value="">Resposta:</option>
			<?php
			while($trad = mysqli_fetch_array($preposition1))
			{
				if( ($trad['traducao']) ==  ($search1['traducao']))
				{
					$valor_verdadeiro =  ($trad['traducao']);
				}
			}
	...
	<div class="panel-body">
		...
		<h3 id="categoria">
			<?php
				...
				echo  ($search2['categoria']);
			?>
		</h3>
		<br>
			
		<input type="text" class="form-control" readonly id="ingles" value="<?php echo  ($search2['palavra']);?>">
		&nbsp&nbsp&nbsp
		
		<select id="traducao" class="form-control" name="traducao" onChange="Send(this.value,'<?php echo  ($search2['palavra']);?>')">
			<option value="">Resposta:</option>
			<?php
			while($trad = mysqli_fetch_array($adverb1))
			{
				if( ($trad['traducao']) ==  ($search2['traducao']))
				{
					$valor_verdadeiro =  ($trad['traducao']);
				}
			}
	...
	<div class="panel-body">
		...
		<h3 id="categoria">
			<?php
				...
				echo  ($search3['categoria']);
			?>
		</h3>
		<br>
			
		<input type="text" class="form-control" readonly id="ingles" value="<?php echo  ($search3['palavra']);?>">
		&nbsp&nbsp&nbsp
		
		<select id="traducao" class="form-control" name="traducao" onChange="Send(this.value,'<?php echo  ($search3['palavra']);?>')">
			<option value="">Resposta:</option>
			<?php
			while($trad = mysqli_fetch_array($conjuction1))
			{
				if( ($trad['traducao']) ==  ($search3['traducao']))
				{
					$valor_verdadeiro =  ($trad['traducao']);
				}
			}
	...
	<div class="panel-body">
		...
		<h3 id="categoria">
			<?php
				...
				echo  ($search4['categoria']);
			?>
		</h3>
		<br>
			
		<input type="text" class="form-control" readonly id="ingles" value="<?php echo  ($search4['palavra']);?>">
		&nbsp&nbsp&nbsp
		
		<select id="traducao" class="form-control" name="traducao" onChange="Send(this.value,'<?php echo  ($search4['palavra']);?>')">
			<option value="">Resposta:</option>
			<?php
			while($trad = mysqli_fetch_array($false1))
			{
				if( ($trad['traducao']) ==  ($search4['traducao']))
				{
					$valor_verdadeiro =  ($trad['traducao']);
				}
			}
	...
	<div class="panel-body">
		...
		<input type="text" readonly class="form-control" id="infinitivo" value="<?php echo  ($search['infinitivo']);?>">
		&nbsp&nbsp&nbsp
		...
		<select id="flexao" class="form-control" name="flexao" onChange="Send2(this.value)">
			...
			if($choice == 0)
			{
				while($flex = mysqli_fetch_array($busca1)) {
					...
					if( ($flex['passado']) ==  ($search['passado']))
					{
						$valor_verdadeiro =  ($flex['passado']);
					}
				...
				while($flex1 = mysqli_fetch_array($busca2)) {
					...
					<option value="<?php echo  ($flex1['passado']) ?>"><?php echo  ($flex1['passado'])?></option>
				<?php
			...
			if($choice == 1)
			{
				while($flex = mysqli_fetch_array($busca1)) {
					...
					if( ($flex['participio']) ==  ($search['participio']))
					{
						$valor_verdadeiro =  ($flex['participio']);
					}
				...
				while($flex1 = mysqli_fetch_array($busca2)) {
					...
					<option value="<?php echo  ($flex1['participio']) ?>"><?php echo  ($flex1['participio'])?></option>
				<?php 
			...
			if($choice == 2)
			{
				while($flex = mysqli_fetch_array($busca1)) {
					...
					if( ($flex['traducao']) ==  ($search['traducao']))
					{
						$valor_verdadeiro =  ($flex['traducao']);
					}
				...
				while($flex1 = mysqli_fetch_array($busca2)) {
					...
					<option value="<?php echo  ($flex1['traducao']) ?>"><?php echo  ($flex1['traducao'])?></option>
				<?php 
